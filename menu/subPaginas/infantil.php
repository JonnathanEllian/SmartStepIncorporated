...
$sql = "SELECT * FROM catalogo WHERE Genero='I'";
...
<head>
    ...
    <style>
        ...
        .hero-section {
    height: 50vh;
    background-image: url('../multimedia/imagenes menu/bannerI.png');
...
<body>
    ...
    <div class="hero-section">
        <div class="hero-text">
            <h1>Descubre Nuestra Colección Infantil</h1>
            <p>Encuentra el calzado perfecto para los Pequeños de la Casa</p>
        </div>
    </div>
