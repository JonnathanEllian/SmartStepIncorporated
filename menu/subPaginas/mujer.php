...
$sql = "SELECT * FROM catalogo WHERE Genero='M'";
...
<head>
    ...
    <style>
        ...
        .hero-section {
    height: 50vh;
    background-image: url('../multimedia/imagenes menu/bannerF.png');
...
<body>
    ...
    <div class="hero-section">
        <div class="hero-text">
            <h1>Descubre Nuestra Colección para Mujeres</h1>
            <p>Encuentra el Calzado Perfecto para Tu Persona</p>
        </div>
    </div>
