...
$sql = "SELECT * FROM catalogo LIMIT 4";
...
function getImagePath($productName) {
    $basePath = 'menu/multimedia/catalogo/';
    ...
    return 'menu/multimedia/default.jpg';
}
?>
...
<head>
    ...
    <style>
        ...
        .hero-section {
    height: 100vh;
    background-image: url('menu/multimedia/imagenes menu/banner.png');
...
<body>
    ...
    <div class="collections-nav">
        <a href="menu/subPaginas/hombre.php">Hombres</a>
        <a href="menu/subPaginas/mujer.php">Mujeres</a>
        <a href="menu/subPaginas/infantil.php">Niños</a>
    </div>

    <div class="hero-section">
        <div class="hero-text">
            <h1>Descubre los mejores tenis</h1>
